angular.module('conFusion.controllers', ['ionic', 'conFusion.controllers','conFusion.services'])

.controller('AppCtrl', function ($scope, $ionicModal, $timeout, $localStorage,$ionicPlatform,$cordovaCamera, $cordovaImagePicker) {
  //$scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera
...
.controller('MenuController', ['$scope', 'dishes', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function ($scope, dishes, favoriteFactory, baseURL, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
    ...
    .then(function (imageData) {
      ...
      console.log(err);
        ...
        //.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'baseURL' ,'$ionicPopover','favoriteFactory','$ionicPlatform',   function($scope, $stateParams, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicPlatform) {
        .controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover','$ionicPlatform', '$ionicModal','$cordovaLocalNotification', '$cordovaToast', function ($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicPlatform, $ionicModal,$cordovaLocalNotification, $cordovaToast) {
            $scope.baseURL = baseURL;
            $scope.dish = dish;
               ...
               $ionicPlatform.ready(function () {
                 ...
                 function () {
                  ...
                  .then(function (success) {
                    ...
                    console.log('Failed to show toast message');
                  });
              });
            }
            $scope.dish = dish;
